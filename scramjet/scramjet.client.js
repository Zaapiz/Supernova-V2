  ...
  var e = {
          ...
          get frame() {
            ...
            if (!t) {
              ...
              for (; e.parent !== e; ) {
                ...
                if (e.frameElement && e.frameElement[o.D]) return e.frameElement[o.D]
                e = e.parent.window
              }
            }
            return t
              ...
              (o.construct = function (e, t, n) {
                ...
                let a = !1,
                  s = {
                    ...
                    call: () => ((a = !0), (o = Reflect.construct(s.fn, s.args, s.newTarget))),
                  }
                return (r.construct(s), a) ? o : Reflect.construct(s.fn, s.args, s.newTarget)
              }),
              r.apply &&
                (o.apply = function (e, t, n) {
                  ...
                  let a = !1,
                    s = {
                      ...
                      call: () => ((a = !0), (o = Reflect.apply(s.fn, s.this, s.args))),
                    },
                    i = Error.prepareStackTrace
                  Error.prepareStackTrace = function (e, t) {
                    if (
                      t[0].getFileName() &&
                      !t[0].getFileName().startsWith(location.origin + u.vc.prefix)
                    )
                  ...
                  try {
                    ...
                    if (e instanceof Error) {
                      if (e.stack instanceof Object)
                        (e.stack = e.stack.stack), console.error('ERROR FROM SCRAMJET INTERNALS', e)
                      else throw e
                    } else throw e
                  }
                      ...
                      : 'getNamedItem' === n
                        ...
                        : 'getNamedItemNS' === n
                          ...
                          : n in NamedNodeMap.prototype && 'function' == typeof a
                            ? new Proxy(a, {
                                apply: (e, n, o) =>
                                  n === r ? Reflect.apply(e, t, o) : Reflect.apply(e, n, o),
                              })
                ...
                return new Proxy(r, {
                  get(e, t) {
                    ...
                    return 'function' == typeof o
                      ? new Proxy(o, { apply: (e, t, n) => Reflect.apply(e, r, n) })
      ...
      2439: function (e, t, r) {
        ...
        function l(e, t) {
          let r = {
              ...
              href: [t.HTMLAnchorElement, t.HTMLLinkElement, t.SVGUseElement, t.SVGImageElement],
            ...
            c = [
              (0, a.nativeGetOwnPropertyDescriptor)(t.HTMLAnchorElement.prototype, 'href'),
              (0, a.nativeGetOwnPropertyDescriptor)(t.HTMLAreaElement.prototype, 'href'),
            ]
          ...
          e.Trap('Node.prototype.baseURI', {
            ...
            e.Trap('Element.prototype.innerHTML', {
                ...
                if (r.this instanceof t.HTMLScriptElement)
                  (o = (0, s.Zs)(n, '(anonymous script element)', e.meta)),
                    e.natives.call(
                      ...
                      btoa(Array.from(i.encode(o), (e) => String.fromCodePoint(e)).join('')),
                    )
                else if (r.this instanceof t.HTMLStyleElement) o = (0, s.U5)(n, e.meta)
                else
                  try {
              ...
              get(r) {
                ...
                return r.this instanceof t.HTMLStyleElement ? r.get() : (0, s.WT)(r.get())
              },
            }),
            ...
            e.Trap('TreeWalker.prototype.currentNode', {
              get: (e) => e.get(),
              set: (r, n) => (n === e.documentProxy ? r.set(t.document) : r.set(n)),
            }),
          ...
          e.Proxy('window.open', {
            apply(t) {
              t.args[0] && (t.args[0] = (0, n.dm)(t.args[0], e.meta)),
                ['_parent', '_top', '_unfencedTop'].includes(t.args[1]) && (t.args[1] = '_self')
              let r = t.call()
          ...
          e.Proxy('EventTarget.prototype.addEventListener', {
            ...
            e.Proxy('ServiceWorkerContainer.prototype.register', {
              apply(t) {
                ...
                Object.setPrototypeOf(o, self.ServiceWorkerRegistration.prototype),
                  (o.constructor = t.fn)
              ...
              get(t, r) {
                switch (r) {
                  ...
                  default:
                    ...
                    return console.log('GET', r, t == n), t.getItem(e.url.host + '@' + r)
                }
              },
              set: (t, r, o) => (
                t == n && console.log('SET', r, o, t === n), t.setItem(e.url.host + '@' + r, o), !0
              ),
              ownKeys: (t) =>
                Reflect.ownKeys(t)
        ...
        function l(e, t) {
          return new Proxy(t, {
            get(t, r) {
              ...
              if ('$scramjet' !== r) return 'string' == typeof r && i.includes(r) ? e.wrapfn(s) : s
            },
            set(t, r, n) {
              if ('location' === r) {
                e.url = n
      ...
      6707: function (e, t, r) {
        ...
        let c = 'window' in self && window instanceof Window,
          ...
          d = 'serviceworker' === new URL(self.location.href).searchParams.get('dest')
      ...
      8971: function (e, t, r) {
        ...
        function i(e, t) {
          ...
          return (
            (i.toString = new Proxy(t.location.toString, { apply: () => e.url.href })),
            t.location.valueOf &&
              (i.valueOf = new Proxy(t.location.valueOf, { apply: () => e.url.href })),
            t.location.assign &&
              (i.assign = new Proxy(t.location.assign, {
                apply(r, n, a) {
                  ;(a[0] = (0, o.dm)(a[0], e.meta)), Reflect.apply(r, t.location, a)
                },
              })),
            t.location.reload &&
      ...
      4423: function (e, t, r) {
        ...
        function o(e, t) {
          Object.defineProperty(t, n.vc.globals.rewritefn, {
            value: function (t) {
              return 'string' != typeof t ? t : (0, n.Zs)(t, '(direct eval proxy)', e.meta)
            },
            writable: !1,
            configurable: !1,
          })
        ...
        function a(e) {
          return 'string' != typeof e
            ? e
            : (0, this.global.eval)((0, n.Zs)(e, '(indirect eval proxy)', this.meta))
        }
      },
      8231: function (e, t, r) {
        'use strict'
        ...
        function c(e, t) {
          let r = {
            message: {
              _init() {
                return ('object' != typeof this.data || !('$scramjet$type' in this.data)) && !0
              },
              ports() {
                return this.ports
              },
              ...
              apply(e, n, o) {
                ...
                if (s.isTrusted) {
                  ...
                  if (t in r) {
                    ...
                    o[0] = new Proxy(s, {
                      get: (t, r, o) => (r in n ? n[r].call(t) : Reflect.get(e, r, o)),
                ...
                return (
                  !t.event &&
                    Object.defineProperty(t, 'event', { get: () => o[0], configurable: !0 }),
                  Reflect.apply(e, n, o)
                )
              },
              getOwnPropertyDescriptor: a.getOwnPropertyDescriptorHandler,
          ...
          e.Proxy('EventTarget.prototype.addEventListener', {
            apply(t) {
              if (((0, i.unproxy)(t, e), 'function' != typeof t.args[1])) return
              let r = t.args[1],
                n = c(r)
              t.args[1] = n
              let o = e.eventcallbacks.get(t.this)
              ;(o ||= []).push({ event: t.args[0], originalCallback: r, proxiedCallback: n }),
            ...
            e.Proxy('EventTarget.prototype.removeEventListener', {
              apply(t) {
                ...
                if (-1 === n) return
                let o = r.splice(n, 1)
                e.eventcallbacks.set(t.this, r), (t.args[1] = o[0].proxiedCallback)
              },
            }),
            ...
            for (let t of Reflect.ownKeys(o))
              if ('string' == typeof t && t.startsWith('on') && r[t.slice(2)]) {
                ...
                e.RawTrap(o, t, {
                  ...
                  set(e, t) {
                    if (((this[l] = t), 'function' != typeof t)) return e.set(t)
                    e.set(c(t))
                  },
                })
              }
      ...
      4306: function (e, t, r) {
        ...
        function u() {
          return (
            (null === c || c.buffer !== n.memory.buffer) && (c = new Uint8Array(n.memory.buffer)), c
          )
        }
        function p(e, t) {
        ...
        function y(e, t, r) {
          ...
          if (s !== n) {
            0 !== s && (e = e.slice(s)), (o = r(o, n, (n = s + 3 * e.length), 1) >>> 0)
        ...
        function h() {
          return (
            (null === m || m.buffer !== n.memory.buffer) && (m = new DataView(n.memory.buffer)), m
          )
        }
        function b(e) {
          return null == e
        ...
        function x() {
          ...
          return (
            ...
            (e.wbg.__wbg_static_accessor_GLOBAL_THIS_1a6eb482d12c9bfb = function () {
            ...
            (e.wbg.__wbindgen_string_get = function (e, t) {
              ...
              var o = b(r) ? 0 : y(r, n.__wbindgen_malloc, n.__wbindgen_realloc),
                a = f
            ...
            (e.wbg.__wbindgen_uint8_array_new = function (e, t) {
              var r,
                o,
                a = ((r = e), (o = t), (r >>>= 0), u().subarray(r / 1, r / 1 + o)).slice()
                    ...
                    return (
                      ...
                      (function (e, t, r) {
                        if ((0, a.Sp)('naiiveRewriter', r.origin)) {
                          let t = 'string' == typeof e ? e : new TextDecoder().decode(e)
                          return (
                            console.log('naiive'),
                            (function (e) {
                              return (
                        ...
                        return (e = (function (e, t, r) {
                          ...
                          try {
                            o =
                              'string' == typeof e
                                ? (function (e, t, r, o) {
                                    let a = y(e, n.__wbindgen_malloc, n.__wbindgen_realloc),
                                      s = f,
                                      i = y(t, n.__wbindgen_malloc, n.__wbindgen_realloc),
                                      l = f,
                                      c = y(r, n.__wbindgen_malloc, n.__wbindgen_realloc),
                                      u = f,
                                ...
                                : (function (e, t, r, o) {
                                    let a = (function (e, t) {
                                        ...
                                        return u().set(e, r / 1), (f = e.length), r
                                      ...
                                      c = y(r, n.__wbindgen_malloc, n.__wbindgen_realloc),
                                      p = f,
                                      g = n.rewrite_js_from_arraybuffer(a, s, i, l, c, p, o)
                                    if (g[2]) throw w(g[1])
                                    return w(g[0])
                                  })(new Uint8Array(e), r.base.href, t || '(unknown)', a.h3)
                          } catch (r) {
                            throw (
                              (console.error('failed rewriting js for', t, r, e),
                          ...
                          if ((0, a.Sp)('rewriterLogs', r.base)) {
                            let e
                            e =
                              p < 1n ? 'BLAZINGLY FAST' : p < 500n ? 'decent speed' : 'really slow'
                            let r = (i - s - Number(p)).toFixed(2)
                            console.log(
                              `oxc rewrite for "${t || '(unknown)'}" was ${e} (${p}ms; ${r}ms overhead)`,
                            )
                          }
                          return 'string' == typeof e ? T.decode(l) : l
                        })(e, t, r))
                      })(e.slice(11), '(javascript: url)', t)
                    )
                  if (e.startsWith('blob:')) return location.origin + a.h3.config.prefix + e
                  if (e.startsWith('data:')) return location.origin + a.h3.config.prefix + e
                  else {
                    ...
                    r.startsWith('about:') &&
                      (r = (function (e) {
                        ...
                        if (e.startsWith(t + 'blob:')) return e.substring(t.length)
                        else if (e.startsWith(t + 'data:')) return e.substring(t.length)
                        else if (e.startsWith('mailto:') || e.startsWith('about:')) return e
                        else if (E(e))
                          return a.h3.codec.decode(
                            e.slice((location.origin + a.h3.config.prefix).length),
                          )
                        else return e
                      })(self.location.href))
                    let n = E(e, r)
                    return n ? location.origin + a.h3.config.prefix + a.h3.codec.encode(n.href) : e
                  }
                })(s, e.meta)}")`,
              )()
            }
      ...
      106: function (e, t, r) {
        ...
        function a(e, t) {
          e.Proxy('fetch', {
            ...
            e.Trap('Response.prototype.url', { get: (e) => (0, o.Sd)(e.get()) }),
          ...
          e.Proxy('XMLHttpRequest.prototype.open', {
            ...
            e.Proxy('XMLHttpRequest.prototype.send', {
              apply(t) {
                ...
                let i = new SharedArrayBuffer(1024, { maxByteLength: 0x7fffffff }),
                  l = new DataView(i)
                ...
                e.RawTrap(t.this, 'status', { get: () => u }),
                  ...
                  e.RawTrap(t.this, 'response', {
                    get: () => ('arraybuffer' === t.this.responseType ? y.buffer : m),
                  }),
                  e.RawTrap(t.this, 'responseXML', {
                    get: () => new DOMParser().parseFromString(m, 'text/xml'),
                  }),
                  e.RawTrap(t.this, 'getAllResponseHeaders', { get: () => () => g }),
            ...
            e.Trap('XMLHttpRequest.prototype.responseURL', { get: (e) => (0, o.Sd)(e.get()) })
        }
      },
      6321: function (e, t, r) {
        'use strict'
        ...
        function o(e, t) {
          e.Proxy('Worker', {
            ...
            e.Proxy('SharedWorker', {
              construct({ args: t, call: r }) {
                ;(t[0] = (0, n.dm)(t[0], e.meta) + '?dest=worker'),
                  t[1] && 'string' == typeof t[1] && (t[1] = `${e.url.origin}@${t[1]}`),
                  t[1] &&
                    'object' == typeof t[1] &&
      ...
      7706: function (e, t, r) {
        ...
        function i(e, t) {
          return function (r) {
            ...
            if (n.iswindow) {
              if (r === t.parent) return o.a in t.parent ? t.parent[o.a].globalProxy : e.globalProxy
	...
	`,
      ...
      4471: function (e, t, r) {
        ...
        let {
            ...
            url: { rewriteUrl: i, unrewriteUrl: l, rewriteBlob: c, unrewriteBlob: u },
            rewrite: {
              rewriteCss: p,
              unrewriteCss: f,
              rewriteHtml: g,
