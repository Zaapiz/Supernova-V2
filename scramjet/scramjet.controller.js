          ...
          fmt: function (e, r, ...t) {
            ...
            Error.prepareStackTrace = (e, r) => {
              ...
              for (let e = 1; e < Math.min(2, r.length); e++)
                r[e].getFunctionName() && (t += `${r[e].getFunctionName()} -> ` + t)
  ...
  window.ScramjetController = class e {
    ...
    constructor(e) {
      let r = {
        ...
        t = (e, r) => {
          for (let o in r) r[o] instanceof Object && o in e && Object.assign(r[o], t(e[o], r[o]))
    ...
    encodeUrl(e) {
      return e instanceof URL && (e = e.toString()), i.config.prefix + i.codec.encode(e)
    }
    decodeUrl(e) {
    ...
    async openIDB() {
      ...
      return new Promise((r, t) => {
        ;(e.onsuccess = async () => {
          ...
          (e.onupgradeneeded = () => {
            let r = e.result
            !r.objectStoreNames.contains('config') && r.createObjectStore('config'),
              !r.objectStoreNames.contains('cookies') && r.createObjectStore('cookies')
          }),
          (e.onerror = () => t(e.error))
      })
    }
