...
<template>
  <div class="flex flex-col justify-center items-center">
    ...
    <div class="flex justify-center space-x-5">
      <img
        class="w-60 h-60 hover:cursor-pointer"
        :src="props.classroomimg"
        @click="stuff('/pics/favicon/classroom.png')"
      />
      <img
        class="w-60 h-60 hover:cursor-pointer"
        :src="props.driveimg"
        @click="stuff('/pics/favicon/drive.png')"
      />
      <img
        class="w-60 h-60 hover:cursor-pointer"
        :src="props.gmailimg"
        @click="stuff('/pics/favicon/gmail.ico')"
      />
      <img
        class="w-60 h-60 hover:cursor-pointer"
        :src="props.googleimg"
        @click="stuff('/pics/favicon/google.ico')"
      />
    </div>
  </div>
  <div class="flex flex-col justify-center items-center">
    ...
    <input
      v-model="iconurl"
      class="w-textw h-16 m-3 font-poppins rounded-3xl text-2xl"
      type="input"
