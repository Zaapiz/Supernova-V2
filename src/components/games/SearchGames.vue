  ...
  <div class="flex justify-center m-6">
    <div class="relative w-96 sm:w-textw">
      <input
        ...
        class="w-full rounded-3xl outline-hidden transition-all h-12 text-center text-2xl"
        ref="searchInput"
        :class="{
      ...
      <Transition name="slide">
        <div
          ...
          @mouseenter="items.dropdown = true"
          @mouseleave="items.dropdown = false"
        >
